...
class SumCheckerController extends Controller
{
    ...
    public function set_paths(Request $request){
        try{
            if ($request->paths!='none' and $request->paths!=null){
                ...
                AdminController::log_record('Выбрал файлы для контрольной суммы');
                try{
    ...
    public function sumchecker_cmd(Request $request){
        ...
        if ($request->type=='update'){
            ...
            $data=array('data'=>$output,
               'code'=>$code);
            AdminController::log_record('Обновил контрольные суммы');
            return $data;
        }
            ...
            $data=array('data'=>$output,
                'code'=>$code);
            AdminController::log_record('Проверил контрольные суммы');
            return $data;
        }
        else{
            return null;
    ...
    public function get_all_logs(){
        ...
        AdminController::log_record('Просмотрел логи контрольных сумм');
        return $data;
    }
