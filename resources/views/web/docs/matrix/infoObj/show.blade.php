...
{{--            <div class="card-header" style="width: 1242px"><h2 class="text-muted" style="text-align: center" >Просмотр информации о элементе ОПО</h2></div>--}}
{{--        </div>--}}
        ...
        <div class="inside_tab_padding">
            <div class="row_block">
                <div style="background: #FFFFFF; height:55rem; padding: 35px; border-radius: 6px"
                     class="container">
                    <div class="card-header"><h2 class="text-muted" style="text-align: center" >Просмотр информации о элементе ОПО</h2></div>
                    ...
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            <div class="form-group">
                                {!! Form::text('idObj', null, array('placeholder' => 'Укажите номер элемента ОПО','style' => 'height: 3vh; width: 70%', 'autocomplete'=>"off", 'class'=>'form-control', 'disabled')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            <div class="form-group">
                                {!! Form::text('nameObj', null, array('placeholder' => 'Укажите наименование элемента ОПО','style' => 'height: 3vh; width: 85%', 'autocomplete'=>"off", 'class'=>'form-control', 'disabled')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            <div class="form-group">
                                {!! Form::text('uppg', null, array('placeholder' => 'Укажите номер при наличии','style' => 'height: 3vh; width: 85%', 'autocomplete'=>"off", 'class'=>'form-control', 'disabled')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            {!! Form::select('InUse', array('1' => 'Используется', '0' => 'Не используется'), null, ['style' => 'width: 90%', 'class'=>'form-control', 'disabled']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <select class="form-control" disabled name="QP1_TYPE" id="selct_per5">
                ...
                <div class="card-header">
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <select class="form-control" disabled name="idOPO" id="selct_per2">
                ...
                <div class="card-header">
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            <div class="form-group">
                                {!! Form::text('descObj', null, array('placeholder' => 'Укажите полное наименование элемента ОПО','style' => 'height: 3vh; width: 85%', 'autocomplete'=>"off", 'class'=>'form-control', 'disabled')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <select class="form-control" disabled name="typeObj" id="selct_per3">
                ...
                <div class="card-header">
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <select class="form-control" disabled name="status" id="selct_per3">
                ...
                <div class="card-header">
                    <div class="row justify-content-start">
                        ...
                        <div class="col">
                            {!! Form::select('type_project', array('W1' => '1 очередь', 'W' => '2 очередь', '' => 'Нет данных'), null, ['style' => 'width: 90%', 'class'=>'form-control', 'disabled']) !!}
                        </div>
                    </div>
                </div>
